...
if __name__ == '__main__':
    ...
    if method == 'lore':
        if lang == 'w':
            ...
            read_from_exp_lore('../datasets/D_W/exp_' + method1, num, '../datasets/D_W/exp_'+ method +'1', rules)
        elif lang == 'w2':
            rules = read_rule('../datasets/D_W2/exp_' + method)
            read_from_exp_lore('../datasets/D_W2/exp_' + method1, num, '../datasets/D_W2/exp_'+ method +'1', rules)
        elif lang == 'y':
            rules = read_rule('../datasets/D_Y/exp_' + method)
            read_from_exp_lore('../datasets/D_Y/exp_' + method1, num, '../datasets/D_Y/exp_'+ method +'1', rules)
        elif lang == 'z2':
            rules = read_rule('../datasets/dbp_z_e_wrong/exp_' + method)
            read_from_exp_lore('../datasets/dbp_z_e_wrong/exp_' + method1, num, '../datasets/dbp_z_e_wrong/exp_'+ method +'1', rules)
        else:
            rules = read_rule('../datasets/dbp_' + lang + '_e/exp_' + method)
            read_from_exp_lore('../datasets/dbp_' + lang + '_e/exp_' + method1, num, '../datasets/dbp_' + lang + '_e/exp_'+ method +'1', rules)
    elif method == 'anchor':
        if lang == 'w':
            rules = read_rule('../datasets/D_W/exp_' + method)
            read_from_exp_anchor('../datasets/D_W/exp_' + method1, num, '../datasets/D_W/exp_'+ method +'1', rules)
        elif lang == 'w2':
            rules = read_rule('../datasets/D_W2/exp_' + method)
            read_from_exp_anchor('../datasets/D_W2/exp_' + method1, num, '../datasets/D_W2/exp_'+ method +'1', rules)
        elif lang == 'z2':
            rules = read_rule('../datasets/dbp_z_e_wrong/exp_' + method)
            read_from_exp_anchor('../datasets/dbp_z_e_wrong/exp_' + method1, num, '../datasets/dbp_z_e_wrong/exp_'+ method +'1', rules)
        elif lang == 'y':
            rules = read_rule('../datasets/D_Y/exp_' + method)
            read_from_exp_anchor('../datasets/D_Y/exp_' + method1, num, '../datasets/D_Y/exp_'+ method +'1', rules)
        else:
            rules = read_rule('../datasets/dbp_' + lang + '_e/exp_' + method)
            read_from_exp_anchor('../datasets/dbp_' + lang + '_e/exp_' + method1, num, '../datasets/dbp_' + lang + '_e/exp_'+ method +'1', rules)
    else:
        if lang == 'w':
            read_from_exp('../datasets/D_W/exp_' + method, num, '../datasets/D_W/exp_'+ method +'1')
        elif lang == 'y':
            read_from_exp('../datasets/D_Y/exp_' + method, num, '../datasets/D_Y/exp_'+ method +'1')
        elif lang == 'z2':
            read_from_exp('../datasets/dbp_z_e_wrong/exp_' + method, num, '../datasets/dbp_z_e_wrong/exp_'+ method +'1')
        elif lang == 'j2':
            read_from_exp('../datasets/dbp_j_e_wrong/exp_' + method, num, '../datasets/dbp_j_e_wrong/exp_'+ method +'1')
        elif lang == 'f2':
            read_from_exp('../datasets/dbp_f_e_wrong/exp_' + method, num, '../datasets/dbp_f_e_wrong/exp_'+ method +'1')
        elif lang == 'w2':
            read_from_exp('../datasets/D_W2/exp_' + method, num, '../datasets/D_W2/exp_'+ method +'1')
        else:
            read_from_exp('../datasets/dbp_' + lang + '_e/exp_' + method, num, '../datasets/dbp_' + lang + '_e/exp_'+ method +'1')
    if lang == 'w':
    ...
    if lang == 'w':
        ...
        get_2_no_nec_kg('../datasets/dbp_z_e_wrong/',  '/exp_' + method +'1', split)
        get_2_nec_kg('../datasets/dbp_z_e_wrong/',  '/exp_' + method +'1', split)
    elif lang == 'j2':
        split = len(read_list('../datasets/dbp_j_e_wrong/ent_dict1'))
        get_2_no_nec_kg('../datasets/dbp_j_e_wrong/',  '/exp_' + method +'1', split)
        get_2_nec_kg('../datasets/dbp_j_e_wrong/',  '/exp_' + method +'1', split)
    elif lang == 'f2':
        split = len(read_list('../datasets/dbp_f_e_wrong/ent_dict1'))
        get_2_no_nec_kg('../datasets/dbp_f_e_wrong/',  '/exp_' + method +'1', split)
        get_2_nec_kg('../datasets/dbp_f_e_wrong/',  '/exp_' + method +'1', split)
    elif lang == 'w2':
        split = len(read_list('../datasets/D_W2/ent_dict1'))
        get_2_no_nec_kg('../datasets/D_W2/',  '/exp_' + method +'1', split)
        get_2_nec_kg('../datasets/D_W2/',  '/exp_' + method +'1', split)
    else:
